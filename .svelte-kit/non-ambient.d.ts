...
declare module "$app/types" {
	export interface AppTypes {
		RouteId(): "/" | "/adm-officer" | "/adm-officer/applications" | "/adm-officer/applications/[id]" | "/adm-officer/circulars" | "/adm-officer/dashboard" | "/adm-officer/dashboard/update-comment" | "/adm-officer/export" | "/adm-officer/help" | "/adm-officer/inquiries" | "/adm-officer/merit-list" | "/adm-officer/reports" | "/adm-officer/reports/conversion" | "/adm-officer/saved-reports" | "/adm-officer/saved-reports/[id]" | "/adm-officer/verification" | "/adm-officer/verification/bulk" | "/admin" | "/admin/academic-calendar" | "/admin/admission-sequences" | "/admin/branches" | "/admin/colleges" | "/admin/config-guide" | "/admin/courses" | "/admin/dashboard" | "/admin/docs" | "/admin/fee-schemes" | "/admin/fee-structures" | "/admin/form-types" | "/admin/forms" | "/admin/forms/new" | "/admin/forms/[id]" | "/admin/forms/[id]/edit" | "/admin/help" | "/admin/inquiry-forms" | "/admin/merit-calculation" | "/admin/merit-formulas" | "/admin/payment-gateways" | "/admin/profile-schema" | "/admin/receipt-sequences" | "/admin/report-builder" | "/admin/universities" | "/admin/users" | "/api" | "/api/admin" | "/api/admin/check-form" | "/api/admin/get-form-schema" | "/api/deo" | "/api/deo/get-student-profile" | "/api/inquiry" | "/api/inquiry/check" | "/api/inquiry/emails" | "/api/inquiry/search" | "/api/payment" | "/api/payment/callback" | "/api/payment/create-order" | "/api/payment/verify" | "/api/reports" | "/api/reports/generate" | "/api/reports/profile-data" | "/api/upload" | "/auth" | "/auth/callback" | "/college-auth" | "/college-auth/applications" | "/college-auth/circulars" | "/college-auth/dashboard" | "/college-auth/help" | "/college-auth/reports" | "/deo" | "/deo/applications" | "/deo/apply" | "/deo/dashboard" | "/deo/help" | "/deo/saved-reports" | "/deo/saved-reports/[id]" | "/deo/undertaking" | "/deo/undertaking/[id]" | "/deo/verification" | "/deo/verification/bulk" | "/fee-collector" | "/fee-collector/dashboard" | "/fee-collector/export" | "/fee-collector/help" | "/fee-collector/payments" | "/fee-collector/reports" | "/fee-collector/saved-reports" | "/fee-collector/saved-reports/[id]" | "/inquiry" | "/inquiry/[slug]" | "/login" | "/logout" | "/print-profile" | "/print-profile/[applicationId]" | "/receipts" | "/receipts/print" | "/register" | "/student" | "/student/apply" | "/student/documents" | "/student/help" | "/student/payments" | "/student/profile" | "/student/support" | "/university-auth" | "/university-auth/applications" | "/university-auth/circulars" | "/university-auth/dashboard" | "/university-auth/help" | "/university-auth/reports";
		RouteParams(): {
			...
			"/inquiry/[slug]": { slug: string };
			"/print-profile/[applicationId]": { applicationId: string }
		};
		LayoutParams(): {
			"/": { id?: string; slug?: string; applicationId?: string };
			...
			"/adm-officer/inquiries": Record<string, never>;
			...
			"/admin/fee-schemes": Record<string, never>;
			...
			"/admin/inquiry-forms": Record<string, never>;
			...
			"/api/admin/get-form-schema": Record<string, never>;
			"/api/deo": Record<string, never>;
			"/api/deo/get-student-profile": Record<string, never>;
			"/api/inquiry": Record<string, never>;
			"/api/inquiry/check": Record<string, never>;
			"/api/inquiry/emails": Record<string, never>;
			"/api/inquiry/search": Record<string, never>;
		...
		Pathname(): "/" | "/adm-officer" | "/adm-officer/" | "/adm-officer/applications" | "/adm-officer/applications/" | `/adm-officer/applications/${string}` & {} | `/adm-officer/applications/${string}/` & {} | "/adm-officer/circulars" | "/adm-officer/circulars/" | "/adm-officer/dashboard" | "/adm-officer/dashboard/" | "/adm-officer/dashboard/update-comment" | "/adm-officer/dashboard/update-comment/" | "/adm-officer/export" | "/adm-officer/export/" | "/adm-officer/help" | "/adm-officer/help/" | "/adm-officer/inquiries" | "/adm-officer/inquiries/" | "/adm-officer/merit-list" | "/adm-officer/merit-list/" | "/adm-officer/reports" | "/adm-officer/reports/" | "/adm-officer/reports/conversion" | "/adm-officer/reports/conversion/" | "/adm-officer/saved-reports" | "/adm-officer/saved-reports/" | `/adm-officer/saved-reports/${string}` & {} | `/adm-officer/saved-reports/${string}/` & {} | "/adm-officer/verification" | "/adm-officer/verification/" | "/adm-officer/verification/bulk" | "/adm-officer/verification/bulk/" | "/admin" | "/admin/" | "/admin/academic-calendar" | "/admin/academic-calendar/" | "/admin/admission-sequences" | "/admin/admission-sequences/" | "/admin/branches" | "/admin/branches/" | "/admin/colleges" | "/admin/colleges/" | "/admin/config-guide" | "/admin/config-guide/" | "/admin/courses" | "/admin/courses/" | "/admin/dashboard" | "/admin/dashboard/" | "/admin/docs" | "/admin/docs/" | "/admin/fee-schemes" | "/admin/fee-schemes/" | "/admin/fee-structures" | "/admin/fee-structures/" | "/admin/form-types" | "/admin/form-types/" | "/admin/forms" | "/admin/forms/" | "/admin/forms/new" | "/admin/forms/new/" | `/admin/forms/${string}` & {} | `/admin/forms/${string}/` & {} | `/admin/forms/${string}/edit` & {} | `/admin/forms/${string}/edit/` & {} | "/admin/help" | "/admin/help/" | "/admin/inquiry-forms" | "/admin/inquiry-forms/" | "/admin/merit-calculation" | "/admin/merit-calculation/" | "/admin/merit-formulas" | "/admin/merit-formulas/" | "/admin/payment-gateways" | "/admin/payment-gateways/" | "/admin/profile-schema" | "/admin/profile-schema/" | "/admin/receipt-sequences" | "/admin/receipt-sequences/" | "/admin/report-builder" | "/admin/report-builder/" | "/admin/universities" | "/admin/universities/" | "/admin/users" | "/admin/users/" | "/api" | "/api/" | "/api/admin" | "/api/admin/" | "/api/admin/check-form" | "/api/admin/check-form/" | "/api/admin/get-form-schema" | "/api/admin/get-form-schema/" | "/api/deo" | "/api/deo/" | "/api/deo/get-student-profile" | "/api/deo/get-student-profile/" | "/api/inquiry" | "/api/inquiry/" | "/api/inquiry/check" | "/api/inquiry/check/" | "/api/inquiry/emails" | "/api/inquiry/emails/" | "/api/inquiry/search" | "/api/inquiry/search/" | "/api/payment" | "/api/payment/" | "/api/payment/callback" | "/api/payment/callback/" | "/api/payment/create-order" | "/api/payment/create-order/" | "/api/payment/verify" | "/api/payment/verify/" | "/api/reports" | "/api/reports/" | "/api/reports/generate" | "/api/reports/generate/" | "/api/reports/profile-data" | "/api/reports/profile-data/" | "/api/upload" | "/api/upload/" | "/auth" | "/auth/" | "/auth/callback" | "/auth/callback/" | "/college-auth" | "/college-auth/" | "/college-auth/applications" | "/college-auth/applications/" | "/college-auth/circulars" | "/college-auth/circulars/" | "/college-auth/dashboard" | "/college-auth/dashboard/" | "/college-auth/help" | "/college-auth/help/" | "/college-auth/reports" | "/college-auth/reports/" | "/deo" | "/deo/" | "/deo/applications" | "/deo/applications/" | "/deo/apply" | "/deo/apply/" | "/deo/dashboard" | "/deo/dashboard/" | "/deo/help" | "/deo/help/" | "/deo/saved-reports" | "/deo/saved-reports/" | `/deo/saved-reports/${string}` & {} | `/deo/saved-reports/${string}/` & {} | "/deo/undertaking" | "/deo/undertaking/" | `/deo/undertaking/${string}` & {} | `/deo/undertaking/${string}/` & {} | "/deo/verification" | "/deo/verification/" | "/deo/verification/bulk" | "/deo/verification/bulk/" | "/fee-collector" | "/fee-collector/" | "/fee-collector/dashboard" | "/fee-collector/dashboard/" | "/fee-collector/export" | "/fee-collector/export/" | "/fee-collector/help" | "/fee-collector/help/" | "/fee-collector/payments" | "/fee-collector/payments/" | "/fee-collector/reports" | "/fee-collector/reports/" | "/fee-collector/saved-reports" | "/fee-collector/saved-reports/" | `/fee-collector/saved-reports/${string}` & {} | `/fee-collector/saved-reports/${string}/` & {} | "/inquiry" | "/inquiry/" | `/inquiry/${string}` & {} | `/inquiry/${string}/` & {} | "/login" | "/login/" | "/logout" | "/logout/" | "/print-profile" | "/print-profile/" | `/print-profile/${string}` & {} | `/print-profile/${string}/` & {} | "/receipts" | "/receipts/" | "/receipts/print" | "/receipts/print/" | "/register" | "/register/" | "/student" | "/student/" | "/student/apply" | "/student/apply/" | "/student/documents" | "/student/documents/" | "/student/help" | "/student/help/" | "/student/payments" | "/student/payments/" | "/student/profile" | "/student/profile/" | "/student/support" | "/student/support/" | "/university-auth" | "/university-auth/" | "/university-auth/applications" | "/university-auth/applications/" | "/university-auth/circulars" | "/university-auth/circulars/" | "/university-auth/dashboard" | "/university-auth/dashboard/" | "/university-auth/help" | "/university-auth/help/" | "/university-auth/reports" | "/university-auth/reports/";
		ResolvedPathname(): `${"" | `/${string}`}${ReturnType<AppTypes['Pathname']>}`;
		Asset(): "/fonts/AdwaitaSans-Regular.ttf" | "/fonts/Roboto-Bold.ttf" | "/fonts/Roboto-Regular.ttf" | "/images/hero-bg.jpg" | "/images/login-bg.jpg" | "/robots.txt" | string & {};
	}
}